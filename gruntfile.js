...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            js: {
                files: [{
                    ...
                    },
                    {
                        ...
                        src: ['**/*.js', '**/*.css', '**/*.map', '**/*.eot', '**/*.svg', '**/*.ttf', '**/*.woff', '**/*.woff2',],
                    ...
                    },
                    {
                        ...
                        src: ['**/*.js'],
                        dest: 'public/lib/raphael',
                        expand: true
                    },
                    {
                        cwd: 'bower_components/mocha',
                        src: ['**/*.js'],
                        dest: 'public/lib/mocha',
                        expand: true
                    },
                    {
                    ...
                    {
                        cwd: 'bower_components/rangy',
                        src: ['**/*.js'],
                        dest: 'public/lib/rangy',
                        expand: true
                    },
                    {
                    ...
                    },
                    {
                        ...
                        src: ['*.min.js'],
                        dest: 'public/lib/ng-file-upload',
                        expand: true
                    },
                    {
                        cwd: 'bower_components/ng-file-upload-shim',
                        src: ['*.min.js'],
                        dest: 'public/lib/ng-file-upload-shim',
                        expand: true
                    },
                    {
                    ...
                    {
                        cwd: 'bower_components/angular-google-maps-geocoder/dist',
                        src: ['*.min.js'],
                        dest: 'public/lib/angular-google-maps-geocoder',
                        expand: true
                    },
                    {
                        cwd: 'bower_components/ng-tags-input',
                        src: ['*.min.js', '*.min.js', '*.min.css'],
                        dest: 'public/lib/ng-tags-input',
                        expand: true
                    }
        ...
        concat: {
            ...
            distdesk: {
                src: [
                    ...
                    //Categories Module files
                    'public/app/pages/categories/Category.module.js',
                    'public/app/pages/categories/Category.services.js',
                    'public/app/pages/categories/Category.controller.js',
                    //SubCategories Module files
                    'public/app/pages/subCategories/subCategories.module.js',
                    'public/app/pages/subCategories/subCategories.services.js',
                    'public/app/pages/subCategories/subCategories.controller.js',
                    //orders Module files
                    'public/app/pages/Orders/order.module.js',
                    'public/app/pages/Orders/order.services.js',
                    'public/app/pages/Orders/order.controller.js',
                    //Riders Module files
                    'public/app/pages/Riders/rider.module.js',
                    'public/app/pages/Riders/rider.services.js',
                    'public/app/pages/Riders/rider.controller.js',
                    //PromoCode Module files
                    ...
                    //Products
                    'public/app/pages/Products/product.module.js',
                    'public/app/pages/Products/product.controller.js',
                    'public/app/pages/Products/product.services.js',
                    //Stores
                    'public/app/pages/Stores/store.module.js',
                    'public/app/pages/Stores/store.controller.js',
                    'public/app/pages/Stores/store.services.js',
                    //Promotions
                    'public/app/pages/Promotions/promotion.module.js',
                    'public/app/pages/Promotions/promotion.controller.js',
                    'public/app/pages/Promotions/promotion.services.js',
        ...
        concat_css: {
            ...
            all: {
                src: [
                    ...
                    'public/js/jquery-datatables/datatables.css',
                    'public/js/angular-datatables/css/angular-datatables.css',
                    'public/app/main.css',
        ...
        'cache-busting': {
            ...
            requirejs: {
                replace: ['views/includes/foot.jade'],
                replacement: 'concat.js',
                file: 'public/concat.js',
                get_param: true
            },
            css: {
                replace: ['views/includes/head.jade'],
